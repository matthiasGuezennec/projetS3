...
class produit extends Objet
{
    ...
    {
        return $this->IDProduit . " - " . $this->NomProduit;
    }
    ...
    public static function getID($chaine)
    {
        // On conserve que les chiffres et le premier tiret
        $chiffres = preg_replace("/[^0-9-]/", "", $chaine);

        // On supprime a partir du premier tiret 
        $posPremierTiret = strpos($chiffres, '-');
        if ($posPremierTiret !== false) {
            $chiffres = substr($chiffres, 0, $posPremierTiret);
        }
